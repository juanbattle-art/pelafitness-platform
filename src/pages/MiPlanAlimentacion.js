...
export default function MiPlanAlimentacion({ perfil }) {
  ...
  async function generarPlanesIA() {
    ...
    const prompt = 'Eres nutricionista deportivo. Crea 7 planes de comida diaria DIFERENTES usando SOLO estos alimentos: ' + listaAlimentos + '. OBJETIVO: ' + objetivo + '. CALORIAS EXACTAS: ' + calorias + ' kcal por dia (margen maximo +-50 kcal, es obligatorio). Ajusta las cantidades en gramos de cada alimento para que el total del dia sea exactamente ' + calorias + ' kcal. Reglas: 1) Desayuno con alimentos tipicos de desayuno (avena, huevos, yogur, frutas, pan). 2) Almuerzo y Cena con proteina + carbo + vegetal. 3) Merienda liviana. 4) Calcula los macros correctamente: si un alimento tiene X kcal/100g y usas Y gramos, calorias = redondear(X*Y/100). 5) NO pongas salmon ni carne en el desayuno. 6) NO incluyas calorias_total, proteinas_total, carbohidratos_total, grasas_total. 7) Suma las calorias de todos los items de las 4 comidas y verifica que lleguen a ' + calorias + ' kcal antes de responder. Responde SOLO JSON valido sin texto ni markdown: {"planes":[{"nombre":"Plan Dia 1","comidas":[{"momento":"Desayuno","items":[{"nombre":"Avena","cantidad_gramos":80,"calorias":311,"proteinas":14,"carbohidratos":53,"grasas":6},{"nombre":"Huevo entero","cantidad_gramos":100,"calorias":155,"proteinas":13,"carbohidratos":1,"grasas":11}]},{"momento":"Almuerzo","items":[{"nombre":"Pechuga de pollo","cantidad_gramos":200,"calorias":330,"proteinas":62,"carbohidratos":0,"grasas":8},{"nombre":"Arroz blanco","cantidad_gramos":150,"calorias":195,"proteinas":4,"carbohidratos":42,"grasas":0}]},{"momento":"Merienda","items":[{"nombre":"Yogur griego natural","cantidad_gramos":200,"calorias":118,"proteinas":20,"carbohidratos":8,"grasas":0}]},{"momento":"Cena","items":[{"nombre":"Salmon","cantidad_gramos":150,"calorias":312,"proteinas":30,"carbohidratos":0,"grasas":20}]}]}]}'
