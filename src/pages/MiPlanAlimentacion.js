...
export default function MiPlanAlimentacion({ perfil }) {
  ...
  async function generarPlanIA() {
   ...
   const prompt = `Eres nutricionista deportivo. Crea 1 plan de comida diaria usando SOLO estos alimentos: ${listaAlimentos}. Objetivo: ${objetivo}. Meta calorica: ${calorias} kcal/dia. Usa gramos exactos y variados para ajustar las calorias (ej: 123g, 187g, 234g, 78g). NUNCA uses multiplos de 50 como 100g, 150g, 200g, 250g. Responde SOLO JSON valido sin texto ni markdown: {"nombre":"Plan Dia 1","comidas":[{"momento":"Desayuno","items":[{"nombre":"Avena","cantidad_gramos":80,"calorias":311,"proteinas":14,"carbohidratos":53,"grasas":6}]},{"momento":"Almuerzo","items":[{"nombre":"Pechuga de pollo","cantidad_gramos":180,"calorias":297,"proteinas":56,"carbohidratos":0,"grasas":7}]},{"momento":"Merienda","items":[{"nombre":"Yogur griego natural","cantidad_gramos":200,"calorias":118,"proteinas":20,"carbohidratos":8,"grasas":0}]},{"momento":"Cena","items":[{"nombre":"Merluza","cantidad_gramos":200,"calorias":164,"proteinas":36,"carbohidratos":0,"grasas":2}]}]}`
